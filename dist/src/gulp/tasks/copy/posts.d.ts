 ...
 * @returns
 */
export declare const copyPosts: (_done?: TaskCallback, cpath?: string, options?: Partial<Parameters<typeof parsePost>[2]>) => NodeJS.ReadWriteStream;
/**
 * @see {@link copyPosts}
 */
export declare const copy_posts: (_done?: TaskCallback, cpath?: string, options?: Partial<Parameters<typeof parsePost>[2]>) => NodeJS.ReadWriteStream;
