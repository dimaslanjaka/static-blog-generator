...
export declare function generateSingleIndex(postsChunks: ReturnType<typeof getChunkOf> | ReturnType<typeof post_chunks>, labelNameOrObj?: string | number, meta?: Record<string, any>): Promise<any>;
