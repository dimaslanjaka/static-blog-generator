...
module.exports = class extends Migration {
  ...
  upgrade(config) {
    ...
    if (
      result.search &&
      Object.prototype.hasOwnProperty.call(result.search, 'type')
    ) {
    ...
    if (
      result.comment &&
      Object.prototype.hasOwnProperty.call(result.comment, 'type')
    ) {
      ...
      for (const widget of result.widgets) {
        if (Object.prototype.hasOwnProperty.call(widget, 'type')) {
          switch (widget.type) {
            ...
            case 'tagcloud':
              logger.warn(
                'The tagcloud widget has been removed from Icarus in version 3.0.0.'
              );
