(function ($) {
  ...
  CategoriesFilter.prototype = {
    ...
    countCategories: function (category) {
      return $(
        this.posts + '[data-' + this.dataCategory + "*='" + category + "']"
      ).length;
    },
    ...
    showPosts: function (category) {
      ...
      var categories =
        ...
        "']";
      var posts =
        self.posts + '[data-' + self.dataCategory + "*='" + category + "']";
        ...
        if ($(categories + '[data-' + self.dataParentCategories + ']').length) {
          ...
          $(categories).each(function () {
            ...
            parents.forEach(function (parent) {
              var dataAttr =
                '[data-' + self.dataCategory + "='" + parent + "']";
              $(self.categories + dataAttr).show();
              $(self.posts + dataAttr).show();
              $(
                self.posts + dataAttr + ' > .archive-posts > .archive-post'
              ).hide();
            });
          });
        }
