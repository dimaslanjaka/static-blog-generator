...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['Q'] = factory();
  else root['Q'] = factory();
})(this, function () {
    ...
    /******/ [
          ...
          _.extend(Q.prototype, {
            ...
            _makeReadFilters: function (names, $this) {
              ...
              return names.map(function (args) {
                ...
                var name = args.shift();
                var reader = filters[name]
                  ? filters[name].read || filters[name]
                  : _.noexist(self, name);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function createClass(name) {
          return new Function(
            'return function ' + name + ' (options) { this._init(options) }'
          )();
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = {
          ...
          text: function (value) {
            ...
            value !== undefined &&
              (text =
                typeof this.el.textContent === 'string'
                  ? 'textContent'
                  : 'innerText') &&
              (this.el[text] = value == null ? '' : value.toString());
          },
          html: function (value) {
        ...
        exports.bind = function () {
          ...
          vm.$watch(
            ...
            function (value, oldVal, patch) {
              ...
              if (
                clean &&
                clean(parentNode, repeats, value, vm._watchers, target) === true
              ) {
                return;
              }
            ...
            res.forEach(function (obj) {
              ...
              directive &&
                descriptors.forEach(function (descriptor) {
                  var readFilters = self._makeReadFilters(
                      descriptor.filters,
                      self.data(namespace)
                    ),
                    key = descriptor.target,
                    target = _.get(namespace, key),
                    update = _.isObject(directive)
                      ? directive.update
                      : directive,
                    that = _.extend(
                      {
                  ...
                  if (_.isObject(directive) && directive.bind)
                    directive.bind.call(that);
                });
            });
          });
        };
