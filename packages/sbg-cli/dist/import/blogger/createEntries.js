...
function createEntries(xmlFile) {
    ...
    sbg_utility_1.default.writefile(path_1.default.join(process.cwd(), `tmp/sbg-main/${path_1.default.basename(xmlFile)}-rss.xml`), xmlString);
    sbg_utility_1.default.writefile(path_1.default.join(process.cwd(), `tmp/sbg-main/${path_1.default.basename(xmlFile)}-inner.xml`), document.documentElement.innerHTML);
    sbg_utility_1.default.writefile(path_1.default.join(process.cwd(), `tmp/sbg-main/${path_1.default.basename(xmlFile)}-entry.xml`), entries[0].innerHTML);
    return {
        dom,
        window: dom.window,
        document
