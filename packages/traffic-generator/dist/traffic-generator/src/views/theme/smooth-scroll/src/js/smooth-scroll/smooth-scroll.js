    ...
    var SmoothScroll = function (selector, options) {
        ...
        smoothScroll.animateScroll = function (anchor, toggle, options) {
            ...
            var endLocation = isNum
                ? anchor
                : getEndLocation(anchorElem, headerHeight, parseInt(typeof _settings.offset === "function"
                    ? _settings.offset(anchor, toggle)
                    : _settings.offset, 10), _settings.clip); // Location to scroll to
        ...
        var clickHandler = function (event) {
            ...
            if (toggle.hostname !== window.location.hostname ||
