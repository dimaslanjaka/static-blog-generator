...
const removeUnusedMenuItems = (menuTemplate) => {
    ...
    return menuTemplate
        ...
        const toDelete = menuItem.type === "separator" &&
...
const create = (win, options) => {
    const handleContextMenu = (event, props) => {
        ...
        const shouldShowInspectElement = typeof options.showInspectElement === "boolean"
        ...
        for (const menuItem of menuTemplate) {
            ...
            if (typeof menuItem.label === "string" &&
                ...
                const selectionString = typeof props.selectionText === "string"
