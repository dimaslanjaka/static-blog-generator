...
var fm = sbgUtils.utils.filemanager;
var Logger = sbgUtils.utils.logger.default;
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    Logger.log('write to', (0, upath_1.toUnix)(oriPath).replace((0, upath_1.toUnix)(config.cwd), ''), oriUp, '->', post.attributes.updated);
                    return [4 /*yield*/, fm.writefile(oriPath, rebuild, { async: true })];
                case 2:
                    _a.sent(); // write original post
                    build = (0, hexo_post_parser_1.buildPost)(parse);
                    return [4 /*yield*/, fm.writefile(postPath, build, { async: true })];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    Logger.log('cannot parse', postPath);
                    fm.writefile((0, upath_1.join)(config.cwd, 'tmp/errors', updatePost.name, 'cannot-parse.log'), postPath, { append: true });
                    _a.label = 5;
                case 5:
