 ...
 * @returns
 */
export declare function data_to_hash(alogarithm: ("sha1" | "sha256" | "sha384" | "sha512" | "md5") | undefined, data: crypto.BinaryLike, encoding?: import('crypto').BinaryToTextEncoding): Promise<string>;
/**
 ...
 * @returns
 */
export declare function url_to_hash(alogarithm: ("sha1" | "sha256" | "sha384" | "sha512" | "md5") | undefined, url: string, encoding?: crypto.BinaryToTextEncoding): Promise<unknown>;
