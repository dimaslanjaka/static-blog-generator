...
function arrayOfObjUniq(arr, field) {
    ...
    return arr.filter(function (a, i) { return arr.findIndex(function (s) { return a[field] === s[field]; }) === i; });
}
...
function array_flatten(arr, depth) {
    ...
    return arr.reduce(function (acc, cur) { return acc.concat(Array.isArray(cur) ? array_flatten(cur) : cur); }, []);
}
