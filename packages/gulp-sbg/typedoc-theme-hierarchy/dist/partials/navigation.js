    ...
    return (<div class='tree'>
        ...
        <div class='tree-config'>
          <button class='tree-config__button tree-config__button--expand js-tree-expand' title='Expand All'>
            <svg xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 490.72 490.72' fill='currentColor'>
          ...
          <button class='tree-config__button tree-config__button--collapse js-tree-collapse' title='Collapse All'>
            <svg viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' fill='currentColor'>
              <path fill-rule='evenodd' d='M1 8a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 8zm7-8a.5.5 0 0 1 .5.5v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 1 1 .708-.708L7.5 4.293V.5A.5.5 0 0 1 8 0zm-.5 11.707-1.146 1.147a.5.5 0 0 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 11.707V15.5a.5.5 0 0 1-1 0v-3.793z'/>
            </svg>
          </button>
          <button class='tree-config__button tree-config__button--target js-tree-target' title='Scroll to current file'>
...
const Navigation = ({ id, categories, items, context, }) => (<ul class='js-category-list category' data-id={id}>
    {Object.entries(categories).map(([key, item]) => (<li>
    ...
    {items.map((item) => {
        var _a;
        return (<li>
        <a class='category__link js-category-link category__link--ts' href={context.urlTo(item)} data-id={item.url && `/${item.url}`}>
          {item.title}
        </a>
        <ul>
          {(_a = item.children) === null || _a === void 0 ? void 0 : _a.map((subItem) => (<li class={subItem.cssClasses}>
              <a class='category__link js-category-link' href={context.urlTo(subItem)} data-id={subItem.url && `/${subItem.url}`}>
